...
function Comment({
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div
        className={`
        bg-white rounded-lg px-6 pt-6 pb-5 flex flex-row space-x-6        
      `}
      >
        {/* Rating indicator */}
        <div className="bg-veryLightGray pt-3 pb-2 h-24 w-10 rounded-lg flex flex-col items-center space-y-[15px]">
          {/* plus */}
